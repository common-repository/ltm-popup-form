...
<div class="wrap">
    <div class="form-wrap">
        ...
        <h3><?php _e('Popup Email Settings', 'ltm-popup'); ?></h3>
        <form name="ltm-popup-form" method="post" action="options.php">
            ...
            <p><?php _e('Please enter email subject.', 'ltm-popup'); ?></p>
            ...
            <p><?php _e('Enter what you want displayed on the button.', 'ltm-popup'); ?></p>

            <div style="height:5px;"></div>
            <h3><?php _e('Popup Widget Settings', 'ltm-popup'); ?></h3>
			...
			<label for="tag-title"><?php _e('Popup Max Width', 'ltm-popup'); ?></label>
            <input name="ltm_popup_settings[LTM_Popup_Width]" type="text" id="ltm-popup-width" value="<?php if ( isset( $ltm_popup_settings['LTM_Popup_Width'] ) ) echo $ltm_popup_settings['LTM_Popup_Width']; ?>" size="10" />px
            <p><?php _e('Please enter popup box max width.', 'ltm-popup'); ?></p>
			...
			<label for="tag-title"><?php _e('Popup Button Text Color','ltm-popup'); ?></label>
            <input name="ltm_popup_settings[LTM_Popup_Button_Text_Color]" id="ltm-popup-button-text-color" type="text" value="<?php if ( isset( $ltm_popup_settings['LTM_Popup_Button_Text_Color'] ) ) echo $ltm_popup_settings['LTM_Popup_Button_Text_Color']; ?>" />
            ...
            <h3><?php _e('Popup Display Settings', 'ltm-popup'); ?></h3>

<?php
    ...
    Author: John Mann
    Version: 1.0.6
    Plugin URI: http://wordpress.org/plugins/ltm-popup-form/
...
<style>
    div.ltm-show-popup{
	    ...
	    max-width: <?php echo($ltm_popup_settings['LTM_Popup_Width']); ?>px;
    }
	...
	#ltm-popup-box-container-header{
		background-color: <?php echo($ltm_popup_settings['LTM_Popup_Button_Color']); ?>;
	}
	...
	input.ltm-popup-button{
		...
		border-radius: 12px; 
		color: <?php echo($ltm_popup_settings['LTM_Popup_Button_Text_Color']); ?>;
		background-color: <?php echo($ltm_popup_settings['LTM_Popup_Button_Color']); ?>;
	}
</style>
<div class="ltm-show-popup">
<div class="ltm-close-popup" onClick="ltmCloseForm()">X</div>
<a class="ltm-show-popup" href="javascript:ltmPopupOpenForm('ltm-popup-box-container','ltm-popup-box-container-body','ltm-popup-box-container-footer');"><?php echo($ltm_popup_settings['LTM_Popup_Caption']) ?></a>
</div>
<div style="display: none;" id="ltm-popup-box-container">
    ...
    <div id="ltm-popup-box-container-body">
        ...
        <form action="#" name="ltm-popup-form" id="ltm-popup-form">
            ...
            <div id="ltm-popup-box-label">
                <input type="button" name="button" class="ltm-popup-button" value="<?php echo($ltm_popup_settings['LTM_Popup_Button_Text']); ?>" onclick="javascript:ltmPopupSubmit();" />
            </div>
        </form>
    </div>
</div>
...
<?php
    ...
    function ltm_popup_add_javascript_files() 
    {
            ...
            wp_enqueue_script( 'ltm-popup', plugins_url('scripts/ltm-popup.js', __FILE__ ), array('jquery'));
            wp_enqueue_script( 'ltm-popup-form', plugins_url('scripts/ltm-popup-form.js', __FILE__ ), array('jquery'));
    }   
